...
* [jx import](/commands/jx_import/)	 - Imports a local project into Jenkins
* [jx init](/commands/jx_init/)	 - Init Jenkins X
* [jx install](/commands/jx_install/)	 - Install Jenkins X
* [jx logs](/commands/jx_logs/)	 - Tails the log of the latest pod for a deployment
* [jx metrics](/commands/jx_metrics/)	 - Gets the metrics of the latest pod for a deployment
